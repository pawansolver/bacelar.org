...
export default function ContactUsPage() {
  ...
  return (
    <main className="min-h-screen flex flex-col bg-white overflow-x-hidden">
                  ...
                  <form className="flex flex-col gap-3 w-full max-w-2xl mx-auto" onSubmit={onSubmit}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      <div className="flex flex-col">
                        <input
                          ...
                          className={`w-full bg-black/80 border rounded-none px-3 py-2 text-gray-200 placeholder-[#666666] focus:outline-none transition-all duration-300 text-[14px] backdrop-blur-sm ${
                            fieldErrors.name ? 'border-red-500' : 'border-[#222222] focus:border-[#444444]'
                          }`}
                          required
                        />
                      ...
                      <div className="flex flex-col">
                        <input
                          ...
                          className={`w-full bg-black/80 border rounded-none px-3 py-2 text-gray-200 placeholder-[#666666] focus:outline-none transition-all duration-300 text-[14px] backdrop-blur-sm ${
                            fieldErrors.email ? 'border-red-500' : 'border-[#222222] focus:border-[#444444]'
                          }`}
                          required
                        />
                    ...
                    <div className="flex flex-col">
                      <input
                        ...
                        className={`w-full bg-black/80 border rounded-none px-3 py-2 text-gray-200 placeholder-[#666666] focus:outline-none transition-all duration-300 text-[14px] backdrop-blur-sm ${
                          fieldErrors.phone ? 'border-red-500' : 'border-[#222222] focus:border-[#444444]'
                        }`}
                        required
                      />
                    ...
                    <div className="flex flex-col">
                      <textarea
                        ...
                        rows={3}
                        className={`w-full bg-black/80 border rounded-none px-3 py-2 text-gray-200 placeholder-[#666666] focus:outline-none transition-all duration-300 resize-none text-[14px] backdrop-blur-sm ${
                          fieldErrors.message ? 'border-red-500' : 'border-[#222222] focus:border-[#444444]'
                        }`}
                        required
                      />
      ...
      {/* World Class Map Section */}
      <section className="w-full relative py-16 md:py-24 bg-gray-50 border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 md:px-8 mb-12 text-center">
          ...
          <p className="text-gray-500 text-lg md:text-xl font-medium mt-4 max-w-2xl mx-auto">
            Plan your visit to our campus. We are conveniently located and easily accessible.
          </p>
        </div>

        <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
          <div className="w-full h-[450px] md:h-[600px] rounded-3xl overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-white relative">
            {/* The Map Embed */}
            <iframe
              src="https://maps.google.com/maps?q=Birla%20Heritage%20International%20School%20Siwan&t=&z=15&ie=UTF8&iwloc=&output=embed"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
            ...
            <div className="absolute bottom-6 left-6 md:bottom-10 md:left-10 bg-white/95 backdrop-blur-md p-6 md:p-8 rounded-2xl shadow-2xl border border-white/60 max-w-sm transition-transform duration-300 hover:-translate-y-2">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-bold text-[#312e81]">Visit Campus</h3>
              </div>
              <p className="text-gray-800 font-bold mb-1">Birla Heritage International School</p>
              <p className="text-gray-600 text-sm leading-relaxed mb-6">
                Survey No 813 - 817 Markan, Near Andar Dhala, Siwan, Bihar - 841226
              </p>
              <a
                href="https://maps.app.goo.gl/kKdm42kztKnhxRaT6"
                target="_blank"
                rel="noopener noreferrer"
                className="w-full flex items-center justify-center gap-2 bg-[#f97316] hover:bg-[#ea580c] text-white font-semibold py-3 px-6 rounded-xl transition-all duration-300 shadow-md hover:shadow-lg hover:-translate-y-0.5"
              >
                Get Directions
